...
//
//    JsonDecoder[Int].map(ModelObjectId.apply)
//
//  }
//  given JsonEncoder[ModelObjectId] with {
//
//    JsonEncoder[Int].contramap[ModelObjectId](_.asInt)
//
//  }
//  given JsonDecoder[ModelObjectType] with {
//
//    JsonDecoder[String].map(ModelObjectType.valueOf)
//
//  }
...
//
//    JsonEncoder[String].contramap[ModelObjectType](_.toString)
//
//  }
